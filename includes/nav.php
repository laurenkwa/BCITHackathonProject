...
<div class="text-center" style="background-color: #eee;padding: 10px;">
  ...
  if (isset($_SESSION['access_token'])) {
    ...
    echo('<p><a href="https://slack.com/oauth/authorize?client_id=155127176102.293670961635&amp;scope=identity.basic&amp;redirect_uri=https%3A%2F%2Fride-share.azurewebsites.net%2Fprocess_login.php"><img src="https://platform.slack-edge.com/img/sign_in_with_slack.png" srcset="https://platform.slack-edge.com/img/sign_in_with_slack.png 1x, https://platform.slack-edge.com/img/sign_in_with_slack@2x.png 2x"></a></p>');
  }
  ?>
</div>